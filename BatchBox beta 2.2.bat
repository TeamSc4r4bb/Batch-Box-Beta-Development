...
for /f "tokens=3 delims= " %%a in ('reg query HKCU\Software\BatchBoxBeta\!version! /v b00') do (set b00=%%a) && echo loading b00
for /f "tokens=3 delims= " %%a in ('reg query HKCU\Software\BatchBoxBeta\!version! /v b01') do (set b01=%%a) && echo loading b01
for /f "tokens=3 delims= " %%a in ('reg query HKCU\Software\BatchBoxBeta\!version! /v b02') do (set b02=%%a) && echo loading b02
for /f "tokens=3 delims= " %%a in ('reg query HKCU\Software\BatchBoxBeta\!version! /v b03') do (set b03=%%a) && echo loading b03
for /f "tokens=3 delims= " %%a in ('reg query HKCU\Software\BatchBoxBeta\!version! /v b04') do (set b04=%%a) && echo loading b04
for /f "tokens=3 delims= " %%a in ('reg query HKCU\Software\BatchBoxBeta\!version! /v b05') do (set b05=%%a) && echo loading b05
for /f "tokens=3 delims= " %%a in ('reg query HKCU\Software\BatchBoxBeta\!version! /v b06') do (set b06=%%a) && echo loading b06
for /f "tokens=3 delims= " %%a in ('reg query HKCU\Software\BatchBoxBeta\!version! /v b07') do (set b07=%%a) && echo loading b07
for /f "tokens=3 delims= " %%a in ('reg query HKCU\Software\BatchBoxBeta\!version! /v b08') do (set b08=%%a) && echo loading b08
for /f "tokens=3 delims= " %%a in ('reg query HKCU\Software\BatchBoxBeta\!version! /v b09') do (set b09=%%a) && echo loading b09
for /l %%e in (10, 1, 100) do (for /f "tokens=3 delims= " %%a in ( 'reg query HKCU\Software\BatchBoxBeta\!version! /v b%%e') do (set b%%e=%%a) && echo loading b%%e )
